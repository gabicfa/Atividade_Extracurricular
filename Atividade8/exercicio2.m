...
% Last Modified by GUIDE v2.5 16-Apr-2017 15:56:08
...
global a
a = get(gcbo,'value');
imprime = findobj(gcbf,'tag','edit1');
set(imprime,'string',sprintf('%3.1f',a));
...
deslizar = findobj(gcbf,'tag','slider1');
set(deslizar,'value',a);
